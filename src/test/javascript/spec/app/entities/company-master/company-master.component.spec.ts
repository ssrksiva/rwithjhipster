...
import { CompanyMasterComponent } from 'app/entities/company-master/company-master.component';
...
describe('Component Tests', () => {
    describe('CompanyMaster Management Component', () => {
        let comp: CompanyMasterComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompanyMasterComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.companyMasters[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
